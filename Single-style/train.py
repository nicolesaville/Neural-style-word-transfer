...
def build_parser():
    ...
    parser.add_argument('--style-dir', type=str,
                        dest='style', help='style target path',
...
def main():
    ...
    # Set arguments and configs from parser
    kwargs = {
    ...
    wandb.init(project='faststyle', entity='nicolesaville', config=configs, settings=wandb.Settings(start_method='fork'))
    config = wandb.config

    # Run training using optimise
    for preds, losses, i, epoch in optimise(*args, **kwargs):
